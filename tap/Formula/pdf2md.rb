...
class Pdf2md < Formula
  ...
  # Run `brew fetch --build-from-source pdf2md` after tagging to obtain sha256:
  #   curl -sL https://github.com/raphaelmansuy/edgequake-pdf2md/archive/refs/tags/v0.4.0.tar.gz | sha256sum
